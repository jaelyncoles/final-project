            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="venuedescription" class="col-md-4 col-form-label text-md-right">{{ __('Venue Description') }}</label>

                            <div class="col-md-6">
                                <input id="venuedescription" type="text" class="form-control @error('venuedescription') is-invalid @enderror" name="venuedescription" value="{{ old('venuedescription') }}" placeholder="Hours of Operation, DressCode Information about your venue"required autocomplete="venuedescription" autofocus>
                            </div>
                        </div>
